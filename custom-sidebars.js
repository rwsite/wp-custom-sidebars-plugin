(function () {
    ...
    $ = jQuery, e = function () {
        function e() {
            this.widget_wrap = $(".widget-liquid-right"), this.widget_area = $("#widgets-right"), this.widget_add = $("#tmpl-add-widget"), this.create_form(), this.add_elements(), this.events()
        }

        return e.prototype.create_form = function () {
            this.widget_wrap.append(this.widget_add.html()), this.widget_name = this.widget_wrap.find('input[name="add-widget"]'), this.nonce = this.widget_wrap.find('input[name="scs-delete-nonce"]').val()
